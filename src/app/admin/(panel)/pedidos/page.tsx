...
import { ChevronDown, Loader2, X, Check, Package, Truck, MapPin, Trash2, AlertTriangle } from "lucide-react";
...
const loadOrders = useCallback(async () => {
  setLoading(true);
  // 💡 FIX: Desactivamos la caché para que siempre lea los pedidos frescos
                ...
                <tr key={order.id} className="hover:bg-noir-gray/50 transition-colors cursor-pointer" onClick={() => openOrder(order)}>
                  ...
                  <td className="p-4">
                    <div className="flex items-center gap-3 justify-end">
                      ...
                      <div className="w-[1px] h-4 bg-noir-gray-2" />
    ...
    {deleteId && (
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div className="relative bg-white w-full max-w-sm p-6 text-center">
          ...
          <h2 className="text-sm font-black uppercase mb-2">¿ELIMINAR PEDIDO?</h2>
