...
let subject = "Confirma tu correo — NOIR LOVERS";
let html = `<div style="font-family:sans-serif;max-width:560px;margin:0 auto;background:#0a0a0a;color:#fafafa;padding:48px 32px;">
...
try {
  ...
  console.error("No se pudo cargar diseño BD verificación", e);
}
...
let subject = "Bienvenido a la comunidad 🖤 + 10% de descuento";
let html = `<div style="font-family:sans-serif;max-width:560px;margin:0 auto;background:#0a0a0a;color:#fafafa;padding:48px 32px;">
    <h1 style="font-size:26px;font-weight:900;letter-spacing:-0.02em;margin:0 0 4px;">NOIR LOVERS</h1>
    <p style="font-size:10px;letter-spacing:0.4em;text-transform:uppercase;color:#666;margin:0 0 40px;">BOGOTÁ, COLOMBIA</p>
...
try {
  ...
  console.error("No se pudo cargar diseño BD bienvenida", e);
}
